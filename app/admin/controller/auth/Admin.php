...
use addons\auth\app\admin\model\Admin as Adminmodel;
use addons\auth\app\admin\model\AuthGroupAccess as AuthGroupAccessmodel;
use easy\Random;
use easy\Tree;
 ...
 */
class Admin extends AppBackend
{

    /**
     * @var \addons\auth\app\admin\model\Admin
     */
    ...
    public function _initialize()
    {
        ...
        $groupList = collection(AuthGroup::whereIn('id',  $this->childrenGroupIds)->select()->toArray());
    ...
    public function index()
    {
        if (Request::isAjax()) {
            ...
            foreach ($list as $k => &$v) {
                ...
                $v['groups_text'] = implode(',', array_column($groups,'name'));
            }
            unset($v);
